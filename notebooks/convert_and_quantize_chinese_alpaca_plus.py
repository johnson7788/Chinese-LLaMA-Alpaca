...
get_ipython().system('pip install torch==1.12.0')
...
get_ipython().system('python ./Chinese-LLaMA-Alpaca/scripts/merge_llama_with_chinese_lora.py     --base_model decapoda-research/llama-7b-hf     --lora_model ziqingyang/chinese-llama-plus-lora-7b,ziqingyang/chinese-alpaca-plus-lora-7b     --output_type pth     --output_dir alpaca-combined')
...
get_ipython().system('cd llama.cpp && ./quantize ./zh-models/7B/ggml-model-f16.bin ./zh-models/7B/ggml-model-q8_0.bin 7')


# In[ ]:


get_ipython().system('sha256sum ./llama.cpp/zh-models/7B/ggml-model-q8_0.bin')
...
get_ipython().system('cd llama.cpp && ./main -m ./zh-models/7B/ggml-model-q8_0.bin --color -f ./prompts/alpaca.txt -p "详细介绍一下北京的名胜古迹：" -n 512')
